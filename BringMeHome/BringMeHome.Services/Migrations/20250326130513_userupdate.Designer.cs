...
namespace BringMeHome.Services.Migrations
{
    ...
    [Migration("20250326130513_userupdate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BringMeHome.Services.Database.AnimalColor", b =>
                {
                    b.Property<int>("AnimalColorID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("AnimalColorID"));
            ...
            modelBuilder.Entity("BringMeHome.Services.Database.AnimalTemperamentJunction", b =>
                {
                    ...
                    b.Property<int?>("AnimalTemperamentTemperamentID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AnimalTemperamentTemperamentID");

                    b.HasIndex("AssessedByID");

                    b.HasIndex("TemperamentID");

                    b.ToTable("AnimalTemperamentJunctions");
                });
            ...
            modelBuilder.Entity("BringMeHome.Services.Database.AnimalColor", b =>
                {
                    ...
                    b.HasOne("BringMeHome.Services.Database.Color", null)
                        .WithMany("AnimalColors")
            ...
            modelBuilder.Entity("BringMeHome.Services.Database.AnimalTemperamentJunction", b =>
                {
                    ...
                    b.HasOne("BringMeHome.Services.Database.Animal", null)
                        .WithMany("AnimalTemperaments")
                        .HasForeignKey("AnimalID1");

                    b.HasOne("BringMeHome.Services.Database.AnimalTemperament", null)
                        .WithMany("AnimalTemperaments")
                        .HasForeignKey("AnimalTemperamentTemperamentID");

                    b.HasOne("BringMeHome.Services.Database.Staff", "AssessedBy")
                        .WithMany()
                        .HasForeignKey("AssessedByID")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("BringMeHome.Services.Database.AnimalTemperament", "Temperament")
                        .WithMany()
            ...
            modelBuilder.Entity("BringMeHome.Services.Database.Animal", b =>
                {
                    ...
                    b.Navigation("AnimalTemperaments");
                });
